...
def cq_calculate():
    ...
    grid_return = AgGrid(data, editable=True, fit_columns_on_grid_load=True, height=data.shape[0]*15,
    ...
    if st.button('Calculate'):
        ...
        grid_return = AgGrid(result_df, editable=False, fit_columns_on_grid_load=False, height=result_df.shape[0]*15, theme='streamlit')
